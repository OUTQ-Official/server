export default {
    ...
    //! 유저
    CHECK_ADMIN_SUCCESS: "관리자 확인 성공",
    CHECK_ADMIN_FAIL: "관리자 확인 실패",
    ...
    GET_RECENT_TRACKS_SUCCESS: "최신 개시글 n개 조회 성공",
    GET_RECENT_TRACKS_FAIL: "최신 게시글 n개 조회 실패",
    ...
    INVALID_COMMENT: "올바르지 않은 유저의 댓글",


    //! 포트폴리오 관련
    NOT_PRODUCER: "프로듀서 아님",
    NOT_VOCAL: "보컬 아님",
    GET_USER_PORTFOLIO_FAIL: "유저 포트폴리오 조회 실패",
    ...
    GET_PRODUCER_WORKS_SUCCESS: "프로듀서 포트폴리오/보컬서칭 조회 성공",
    GET_PRODUCER_PORTFOLIO_FAIL: "프로듀서 포트폴리오 조회 실패",
    GET_VOCAL_WORKS_SUCCESS: "보컬 포트폴리오 조회 성공",
    GET_VOCAL_PORTFOLIO_FAIL: "보컬 포트폴리오 조회 실패",
    ...
    GET_RECENT_VOCALS_SUCCESS: "최신 보컬 n개 조회 성공",
    GET_RECENT_VOCALS_FAIL: "최신 보컬 n개 조회 실패",


    //! 이벤트 관련
    UPLOAD_EVENT_SUCCESS: "이벤트 등록 성공",
    UPLOAD_EVENT_FAIL: "이벤트 등록 실패",
    GET_EVENT_LIST_SUCCES: "이벤트 리스트 조회 성공",
    GET_EVENT_LIST_FAIL: "이벤트 리스트 조회 실패",
    GET_EVENT_SUCCES: "이벤트 조회 성공",
    GET_EVENT_FAIL: "이벤트 조회 실패",
    GET_RECENT_EVENT_SUCCESS: "최근 이벤트 count개 조회 성공",
    GET_RECENT_EVENT_FAIL: "최근 이벤트 count개 조회 실패",
    UPDATE_EVENT_SUCCESS: "이벤트 수정 성공",
    UPDATE_EVENT_FAIL: "이벤트 수정 실패",
    DELETE_EVENT_SUCCESS: "이벤트 삭제 성공",
    DELETE_EVENT_FAIL: "이벤트 삭제 실패",
    INVALID_EVENT: "유효하지 않은 이벤트",
    ...
    DELETE_S3_EVENT_OBJECT_FAIL: "S3 이벤트 이미지 객체 삭제 실패",
